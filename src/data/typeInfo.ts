...
export const typeInfo: Record<string, TypeInfo> = {
  ...
  balanced_w1: {
    ...
    name: 'バランス型',
    nameEn: 'BALANCED',
    catchcopy: 'ゲーマー界のスイスアーミーナイフ',
    color: '#C0C0C0',
    description:
      '4つの傾向がほぼ均等に分布している。特定のスタイルに偏らず、どんな場面でも・どんな仲間とでも楽しめる適応力の高さがある。チームに入ると自然と「足りないポジション」を埋められる希少な存在。',
    motivators: [
      '「お前がいるとチームのバランスが取れる」——全方位の適応力を評価されること',
      '「意外と何でもできるな」——多面性を認められること',
      '場面に応じて違う動きができた時——適応力を実感する瞬間',
    ],
    demotivators: [
      '「特徴がないよね」——バランスの良さを個性のなさと言われること',
      '「結局お前は何がしたいの？」——方向性のなさを指摘されること',
      '一つのスタイルを強制されること——自由度を奪われる環境',
    ],
    goodSigns: [
      'チーム内で自然と足りないポジションを埋めている',
      '多面的な貢献ができている。どの場面でも一定の存在感',
    ],
    badSigns: [
      '何でもそこそこだが、どれも中途半端に感じている',
      '「自分って何者？」という迷いが出ている',
    ],
    helpfulActions:
      '「お前の適応力はチームで一番の武器だ」と、万能性そのものを強みとして認めること。「何でもできるからこそ、今チームに一番必要なのは何か」を一緒に考えると、方向性が見えてくる。',
    teamValue:
      'どんなポジションにもフィットできるユーティリティプレイヤー。メンバーの入れ替わりや戦術変更にも対応できるので、チームの保険としても潤滑油としても機能する。',
    overdone:
      '全方位に合わせすぎて自分の軸が見えなくなる。「自分は何がしたいのか」が分からなくなり、周りに流されて疲弊する。',
  },
  ...
  balanced_w2: {
    ...
    name: 'バランス型',
    nameEn: 'BALANCED',
    catchcopy: 'ピンチの万能対応マスター',
    color: '#C0C0C0',
    description:
      'ピンチの時の対応がどれか一つに偏らず、状況を見て柔軟に対応できるタイプ。「何が正解か分からない」と迷うこともあるかもしれないけど、それは複数の選択肢を同時に検討できる能力の表れ。チームにとっては「足りない対応を補ってくれる」ありがたい存在。',
    motivators: [
      '「何が来ても大丈夫な気がする」——万能性を信頼されること',
      '「何でも対応できるの地味にすごい」——オールラウンドさを認められること',
      '場面に応じて違う対応を見せた時「お前、引き出し多いな」と驚かれること',
    ],
    demotivators: [
      '「ピンチの時に頼りにならない」——柔軟さを優柔不断と見なされること',
      '「何でもいいは意見じゃない」——多面性を主張のなさと評価されること',
      '一つの対応を強制されること——「お前は攻めろ」「お前は守れ」',
    ],
    goodSigns: [
      '状況に応じて攻め・守り・分析・励ましを使い分けている',
      '足りない対応を自然と補完してチームが安定している',
    ],
    badSigns: [
      'どの対応が正解か分からず固まってしまう',
      '全方位に気を配りすぎて自分が消耗している',
    ],
    helpfulActions:
      '「どれを選んでも正解。お前の判断を信じる」と選択を肯定すること。迷っている時は「今この瞬間、一番必要なのはどれ？」と問いかけて選択を手伝う。',
    teamValue:
      '足りない対応を自然と補完できる存在。チームの保険かつ潤滑油。固定化した対応パターンに柔軟性を加える。',
    overdone:
      '全方位に気を配りすぎて自分が消耗する。「何もしないよりマシ」と無理にどれかを選んで、結果的にどれも中途半端になる。',
    innerVoice:
      '「何でもそこそこできるけど、何かを極めた人がうらやましいと思うことがある。でもチームが困った時に自然と動けるのは、たぶんこのバランスのおかげ」',
  },
};
